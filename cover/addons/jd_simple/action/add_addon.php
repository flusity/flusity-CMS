...
{ 
    ...
    try {
        ...
        $addon_id = $id;
        $stmt = $db->prepare("INSERT INTO " . $prefix['table_prefix'] . "_jd_simple (title, description, img_url, img_name, menu_id, place_id, addon_id) VALUES (:title, :description, :img_url, :img_name, :menu_id, :place_id, :addon_id)");
