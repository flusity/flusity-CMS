...
{ 
    ...
    try {
        ...
        $stmt = $db->prepare("UPDATE " . $prefix['table_prefix'] . "_flussi_jd_simple SET title = :title, description = :description, img_url = :img_url, img_name = :img_name, menu_id = :menu_id, place_id = :place_id WHERE id = :id");
