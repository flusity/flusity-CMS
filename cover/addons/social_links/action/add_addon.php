...
{ 
    ...
    try {
      ...
      //  $social_link_url = null;
        $addonFolder ="social_links_img"; // Addon default directory
        ...
        $addon_id = $id;
        $stmt = $db->prepare("INSERT INTO " . $prefix['table_prefix'] . "_social_links (title, lang_en_title, img_url, img_name, social_link_url, menu_id, place_id, addon_id) VALUES (:title, :lang_en_title, :img_url, :img_name, :social_link_url, :menu_id, :place_id, :addon_id)");
