...
INSERT INTO contact_form_settings VALUES("1","raktas_457","raktas_457");
...
INSERT INTO settings VALUES("JD website","JD website description","Copyright &copy; JD Theme 2023","1","lt");
...
INSERT INTO translations VALUES("168","lt","Invalid username or password.","Neteisingas vartotojo vardas arba slaptažodis.");
...
INSERT INTO users VALUES("2","Admin","dsssiixxxxc","+37061287842","teggfffst@gmail.com","$argon2i$v=19$m=131072,t=4,p=2$ZTZmMlBYWUIyei5oVkxubQ$tYDYA6syKAU0W5GS1+RkCsEf9zwpkHPvdNJdnmmzyKM","admin");
INSERT INTO users VALUES("4","User","Petraitis","+37061366841","test2@gmail.com","$argon2i$v=19$m=131072,t=4,p=2$Sm9aWWFZcGFkWnJqTG5wbA$TYxEvzRh3tRU/CYXqQdSvHgAtjHZjgf/HqnpoCL77mY","user");
INSERT INTO users VALUES("9","Moderator","Girinis5","+37055557847","test3@gmail.com","$argon2i$v=19$m=131072,t=4,p=2$Q09rY1p5bExBcnouWnBjag$4lj8EPZIAjowxL2qEYOn9+F1f9dIzqFCign/nVFfcaI","moderator");
INSERT INTO users VALUES("14","Darius","Jakaitis","+370678654645","testusers@userv.com","$argon2i$v=19$m=131072,t=4,p=2$OTdhbkhQaUZES3VWSlhBOA$WZmJr3EDw7OPW27Qcqx3+fdW8Q7WWE2I1eFVDe8v4bE","admin");
