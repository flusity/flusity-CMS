...
CREATE TABLE `flussi_tjd_addons` (
  ...
  CONSTRAINT `flussi_tjd_addons_ibfk_1` FOREIGN KEY (`sidebar_id`) REFERENCES `flussi_sidebar` (`id`)
...
INSERT INTO flussi_tjd_addons VALUES("1","jd_simple2","This test addon","8","1","1.1v","JD Flusite","2023-06-18 12:42:36","2023-06-19 09:03:04","0");
INSERT INTO flussi_tjd_addons VALUES("4","jd_simple","This test addon","8","1","1v","JD Flusite","2023-06-21 00:05:55","2023-06-21 00:05:55","0");
