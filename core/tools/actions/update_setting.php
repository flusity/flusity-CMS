...
if (isset($_POST['site_title'], $_POST['meta_description'], $_POST['footer_text'], $_POST['pretty_url'], $_POST['language'],
 $_POST['posts_per_page'], $_POST['registration_enabled'], $_POST['session_lifetime'], $_POST['default_keywords'])) { 
    ...
    if (isset($_FILES["brand_icone"]) && $_FILES["brand_icone"]["size"] > 0) {
        ...
        $file = getFileById($db, $_POST['brand_icone_id']);
   ...
   // $registration_enabled = isset($_POST['registration_enabled']) ? 1 : 0;
    ...
    $updateResult = updateSettings($db, $site_title, $meta_description, $footer_text_settings, $pretty_url, $language, $posts_per_page, $registration_enabled, $session_life, $default_keywords, $brand_icone); 
